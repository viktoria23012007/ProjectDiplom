...
- Ориентировочно, 132 рабочих часа.

## План сдачи работ (когда будут авто-тесты, результаты их прогона и отчёт по автоматизации):

1. Написание тестов до 24 февраля 2023;
2. Предоставление отчетов до 10 марта 2023:
...
- Оформление отчёта по итогам автоматизации - 32 часов.
